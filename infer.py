...
from utils.common import ensure_dir, generate_demo_signals, resolve_device
from utils.logging import build_logger


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="推理多模态扩散模型")
...
def main() -> int:
    ...
    if input_path:
        ...
        demo = generate_demo_signals(batch_size=1, signal_length=int(cfg["data"]["window_length"]), seed=int(cfg["runtime"]["seed"]))
